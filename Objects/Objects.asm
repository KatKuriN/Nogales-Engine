...
ObjectIndex:    
        rsreset   
        rs.b    1
        OBJDEF  Obj_Player,              OBJNO_PLAYER         
        OBJDEF  Obj_Dev1,                   OBJNO_DEV1    
        OBJDEF  Obj_Dev2,                   OBJNO_DEV2
        OBJDEF  Obj_Dev3,                   OBJNO_DEV3
        OBJDEF  Obj_DevDigit1,              OBJNO_DIGIT1
        OBJDEF  Obj_DevDigit2,              OBJNO_DIGIT2
        OBJDEF  Obj_Dev6,                   OBJNO_DEV6
        OBJDEF  Obj_PlayerTest,             OBJNO_PLAYTEST
        OBJDEF  Obj_Dev6,                   OBJNO_TITLEMISC
        OBJDEF  Obj_Dev6,                   OBJNO_TITLESONIC          
        OBJDEF  Obj_Dev6
        OBJDEF  Obj_Dev6
        OBJDEF  Obj_Dev6
        OBJDEF  Obj_Dev6
...
GetObjects_Main:                        
        ...
        beq.w   _getobjZ                ; Exit if within same chunk 
...
_getobjZ:
        ...
        addi.w  #512,d0                 ; Adjust to 1 screen (320pix) ahead
...
.Found:                                
        ...
        include         "Objects/Dev Objects/Dev Objects.asm"
        include         "Objects/Player/Player.asm"
        include         "Objects/Object Collision.asm"
        include         "Objects/Player/Player Test.asm"