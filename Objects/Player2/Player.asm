...
Player_Main:                             
        ...
        beq.s   .Skip
        btst    #4,joypad1PressMirr.w    ; Turn on editor if B pressed
        beq.s   .Skip
        jsr     _objectDelete
        move.b  #OBJNO_DEVINTERFACE,(a0)
        move.w  #$100,obj.X(a0)
        move.w  #$100,obj.Y(a0)
        rts
...
.NotRolling:                           
        ...
        include "GM LEVEL/Objects/Player/play Animate.asm"
        include "GM LEVEL/Objects/Player/play Dynamic GFX.asm"

SprPat_PlaySonic:
        include "GM LEVEL/Objects/Player/Data/sprpat PlaySonic.asm"
DynGfx_PlaySonic:
        include "GM LEVEL/Objects/Player/Data/dgfx PlaySonic.asm"