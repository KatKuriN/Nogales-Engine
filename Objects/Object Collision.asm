...
_physGetFloorAttrAdj:                   
        bsr.w   _physFindBlock          ; a1 = Block address
...
_physGetWallAhead:
        ...
        ; Angle is input in d0

        move.l  obj.X(a0),d3            ; d3 = X
        move.l  obj.Y(a0),d2            ; d2 = Y

        move.w  obj.XSpeed(a0),d1       ; Get X speed
        ext.l   d1
        asl.l   #8,d1
        add.l   d1,d3                   ; Adjust and add to Xpos.

        move.w  obj.YSpeed(a0),d1       ; Get Y speed
        ext.l   d1
        asl.l   #8,d1
        add.l   d1,d2                   ; Adjust and add to Ypos.

        swap    d2                      ; Use as inputs for col chk.
        swap    d3

        move.b  d0,angleFront.w         ; Update angle stack
        move.b  d0,angleBack.w
        move.b  d0,d1
        addi.b  #$20,d0                 ; Get orientation for collision chk
        andi.b  #$C0,d0
