...
Player_Init:                             
        ...
        move.l  #SprPat_PlaySonic,obj.Map(a0)
...
.NotLifted:                           
        jsr     _physBasicChkDown       ; Get floor distance
        cmpi.w  #12,d1                  ; Skip if 12pix drop ahead
        blt.s   .LookUp                

.ChkBalanceRight:
        cmpi.b  #PHYS_LIFTFLAG,play.FootFront(a0)
...
.ChkBalanceLeft:                       
        cmpi.b  #PHYS_LIFTFLAG,play.FootBack(a0)
        bne.s   .LookUp
...
.LookUp:                           
        btst    #0,joypad1Mirr.w     ; If up not pressed, skip
        beq.s   .Duck
        ...
        ; ---- Check for ducking
.Duck:                                 
        btst    #1,joypad1Mirr.w     ; If down not pressed, reset cam. 
        beq.s   .CameraReset        
...
.NotMoving:                            
        ...
        move.b  #1,obj.AnimLast(a0)             ; Set anim update?
