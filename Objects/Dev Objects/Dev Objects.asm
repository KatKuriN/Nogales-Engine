...
TILE.DEV1	EQU  $000+$4000
TILE.DEV2	EQU  $680+$4000
...
Dev1_Init:                            
        ...
        move.l  #SprPat_PalmZ,obj.Map(a0)
        move.w  #TILE.DEV1,obj.Tile(a0) 	; Render on line 4

        move.b  #$C,obj.Render(a0) 	; Render with CamZ
...
; ---------------------------------------------------------------------------
SprPat_PalmZ:
        include "GM LEVEL/Objects/PalmZ/mapspr PalmZ.asm"
...
Dev2_Init:                            
        ...
        move.w  #$40,obj.Y(a0)
        move.l  #SprPat_DevTest,obj.Map(a0)
...
Test05_Init:                            
        addq.b  #2,obj.Action(a0)
        move.l  #SprPat_Digits,obj.Map(a0)
...
; Basically the same object as Obj_DevDigits1, but shifted onscreen by $A0
...
; ---------------------------------------------------------------------------
; Development Object 6 - Placeholder
; ---------------------------------------------------------------------------
