...
; ---------------------------------------------------------------------------
        ...
        include "Level/Camera/scr GreenHill.asm"
        include "Level/Camera/scr Labyrinth.asm"
        include "Level/Camera/scr Marble.asm"
        include "Level/Camera/scr StarLight.asm"        
        include "Level/Camera/scr Sparkling.asm"   
        include "Level/Camera/scr ClockWork.asm"   

SCROLLDEBUG:
        lea     objSlot10.w,a1
        move.w  mainZPosX.w,d0
        bsr.w   .DisplayWord

        lea     objSlot14.w,a1
        move.w  mainZPosY.w,d0
        bsr.w   .DisplayWord

        lea     objSlot18.w,a1
        move.w  hblankLine.w,d0
        bsr.w   .DisplayWord
        rts
...
; ---------------------------------------------------------------------------
; Updates camera-Z X position based on camera-A diff.
; ---------------------------------------------------------------------------

_cameraZSetX:                           
        move.l  cameraZPosX.w,d2
        move.l  d2,d0
        add.l   d4,d0
        ...
        swap    d1
        andi.w  #16,d1
        move.b  cameraZblkX.w,d3
        eor.b   d3,d1
        bne.s   .NotMet
        eori.b  #16,cameraZblkX.w
        sub.l   d2,d0
        bpl.s   .SetRight
        bset    #DRAW.LEFT,camDrawZ.w
        bra.s   .NotMet

.SetRight:                             
        bset    #DRAW.RIGHT,camDrawZ.w
